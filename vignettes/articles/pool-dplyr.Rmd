...
There's one other important tool to note: `local()`. This tells dbplyr to run `input$cyl` locally (retrieving the value the user typed), rather than trying to convert it to SQL.
