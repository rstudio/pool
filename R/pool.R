...
#'
#' @return
#' A pool instance with the following public methods:
#'  \item{\strong{\code{pool$fetch()}}}{
#'    Fetches and returns an object from the pool.
#'  }
#'  \item{\strong{\code{pool$release(id)}}}{
#'    Releases the object with \code{id} back to the pool.
#'  }
#'  \item{\strong{\code{pool$close()}}}{
#'    Closes the pool, terminating any active objects.
#'  }
#'
#' @export
#' @examples
