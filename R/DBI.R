...
#' (mandatory) and \code{\link{poolCreate}} (optional): all arguments
#' should be named:
#' \enumerate{
#'   \item The \code{\link[DBI]{DBIDriver-class} drv} object as well as
#'   the authorization arguments needed by the DBMS instance; these
